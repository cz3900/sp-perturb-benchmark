...
python -c "from spbench.adapters.cpa_export import export_to_cpa_h5; \
           export_to_cpa_h5(data, 'P0', out_dir='dumps/cpa')"
#    -> dumps/cpa/P0.h5ad  +  dumps/cpa/P0_centers.npz ('center_idx','cell_type')
